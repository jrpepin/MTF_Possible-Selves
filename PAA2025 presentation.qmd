...
More salient fact than usual.\
Acknowledge not all scholars are safely able to attend this year.
:::
::::
...
-   ask youth to guess how they foresee their adulthood. 
-   interested in adolescents’ positivity about future selves  
-   how youth think about their potential as good spouses, parents, and workers  
[**\<click\>**]{style="color: #E74C3C;"}\
We argue conceptions of future selves are shaped by  
-   structural contexts (rising inequality + anxiety) in which individuals live  
-   societal norms and values (SDT + intensive parenting) that influence individual aspirations  
changes in work and family roles, technology, and globalization -> suggest change in youth's projection of future self.  
[**\<click\>**]{style="color: #E74C3C;"}\
...
-   strong, pervasive cultural model of the man provider—woman homemaker work-family arrangement, gender differences in beliefs about future selves in these caring roles may be evident  
:::
::::
...
::: aside
Predicted % from ordinal logistic regression with year + year squared
::: 

##  {#slide11-id data-menu-title="Figure 2"}
  
```{r warning = FALSE, fig.width=18, fig.asp=.55}
